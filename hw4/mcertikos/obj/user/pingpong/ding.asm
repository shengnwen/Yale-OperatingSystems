...
4000001c:	f7 c4 ff ff ff 0f    	test   $0xfffffff,%esp
	jnz	args_exist
40000022:	75 04                	jne    40000028 <args_exist>
...
noargs:
	...
	pushl	$0
40000024:	6a 00                	push   $0x0
	pushl	$0
40000026:	6a 00                	push   $0x0
...
args_exist:
	/* Jump to the C part. */
	call	main
40000028:	e8 d3 ff ff ff       	call   40000000 <main>
...
spin:
	//call	yield
	jmp	spin
4000002e:	eb fe                	jmp    4000002e <spin>
...
40000dc0:	e9 8b ff ff ff       	jmp    40000d50 <memmove>
40000dc5:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
40000e72:	c3                   	ret    
40000e73:	90                   	nop
40000e74:	66 90                	xchg   %ax,%ax
40000e76:	66 90                	xchg   %ax,%ax
40000e78:	66 90                	xchg   %ax,%ax
40000e7a:	66 90                	xchg   %ax,%ax
40000e7c:	66 90                	xchg   %ax,%ax
40000e7e:	66 90                	xchg   %ax,%ax
