...
40000044:	f7 c4 ff ff ff 0f    	test   $0xfffffff,%esp
	jnz	args_exist
4000004a:	75 04                	jne    40000050 <args_exist>
...
noargs:
	...
	pushl	$0
4000004c:	6a 00                	push   $0x0
	pushl	$0
4000004e:	6a 00                	push   $0x0
...
args_exist:
	/* Jump to the C part. */
	call	main
40000050:	e8 ab ff ff ff       	call   40000000 <main>

	/* When returning, push the return value on the stack. */
	pushl	%eax
40000055:	50                   	push   %eax

40000056 <spin>:
spin:
	//call	yield
	jmp	spin
40000056:	eb fe                	jmp    40000056 <spin>
40000058:	66 90                	xchg   %ax,%ax
4000005a:	66 90                	xchg   %ax,%ax
4000005c:	66 90                	xchg   %ax,%ax
4000005e:	66 90                	xchg   %ax,%ax
...
40000df0:	e9 8b ff ff ff       	jmp    40000d80 <memmove>
40000df5:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
40000ea2:	c3                   	ret    
40000ea3:	90                   	nop
40000ea4:	66 90                	xchg   %ax,%ax
40000ea6:	66 90                	xchg   %ax,%ax
40000ea8:	66 90                	xchg   %ax,%ax
40000eaa:	66 90                	xchg   %ax,%ax
40000eac:	66 90                	xchg   %ax,%ax
