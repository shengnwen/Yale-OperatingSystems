...
40000054:	f7 c4 ff ff ff 0f    	test   $0xfffffff,%esp
	jnz	args_exist
4000005a:	75 04                	jne    40000060 <args_exist>
...
noargs:
	...
	pushl	$0
4000005c:	6a 00                	push   $0x0
	pushl	$0
4000005e:	6a 00                	push   $0x0
...
args_exist:
	/* Jump to the C part. */
	call	main
40000060:	e8 9b ff ff ff       	call   40000000 <main>

	/* When returning, push the return value on the stack. */
	pushl	%eax
40000065:	50                   	push   %eax

40000066 <spin>:
spin:
	//call	yield
	jmp	spin
40000066:	eb fe                	jmp    40000066 <spin>
...
40000e00:	e9 8b ff ff ff       	jmp    40000d90 <memmove>
40000e05:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
40000eb2:	c3                   	ret    
40000eb3:	90                   	nop
40000eb4:	66 90                	xchg   %ax,%ax
40000eb6:	66 90                	xchg   %ax,%ax
40000eb8:	66 90                	xchg   %ax,%ax
40000eba:	66 90                	xchg   %ax,%ax
40000ebc:	66 90                	xchg   %ax,%ax
